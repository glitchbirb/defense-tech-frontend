...
export function HeaderStats({ stats, lastUpdated }: HeaderStatsProps) {
  return (
    <div className="bg-black border-b border-[#666666] px-6 py-4">
      <div className="flex flex-wrap items-center gap-4 text-sm">
        <div className="flex items-center gap-2">
          <span className="text-[#FFD700] font-bold text-base">DEFENSE-TECH SPENDING TRACKER</span>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-6">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-[#00C853] text-xs font-bold">LIVE</span>
          </div>
        </div>
      </div>
    </div>
...
function StatItem({
  ...
  return (
    <div className="flex items-center gap-2">
      <span className={subdued ? "text-[#666666]" : "text-[#FFA500]"}>
        {label}:
      </span>
      <span className={
        highlight
